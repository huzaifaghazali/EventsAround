                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                               <table  id="example" class="table table-striped custab">
                                    ...
                                    <tbody>
                                      <?php
                                      $sql = "SELECT DISTINCT (`senderID`) as userID FROM `tbl_chat` WHERE `receiverID` = '$organizerID' ORDER BY `id` DESC";
                                        ...
                                        if($result){
                                          ...
                                          while ($row = mysqli_fetch_array($result)) {
                                           ...
                                           <tr>
                                              ...
                                              <td>
                                                <?php echo getUserName($row['userID']); ?>
                                              </td>
                                             
                                             <td><a class='btn btn-danger btn-xs' href="chatBox.php?userID=<?php echo $row['userID']; ?>&organizerID=<?php echo $organizerID; ?>"><span class="fa fa-comments-o"></span> Chat <?php if (getChatNotifications($row['userID'],$organizerID) > 0 ) { ?>
                                             <span class="badge badge-light"><?php echo getChatNotifications($row['userID'],$organizerID); ?>
                                             </span> 
                                             <?php } ?></a></td>
